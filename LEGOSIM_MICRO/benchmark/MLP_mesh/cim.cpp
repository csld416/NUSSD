...
int main(int argc, char** argv){
    ...
    while(1){
        ...
        long long int time_end = InterChiplet::readSync(timeNow, 9, 9, idX, idY, 2 * sizeof(int64_t), 0);
        ...
        fileName = InterChiplet::receiveSync(9, 9, idX, idY);
        global_pipe_comm.read_data(fileName.c_str(), A, Row_A * Col_A * sizeof(double));
        time_end = InterChiplet::readSync(time_end, 9, 9, idX, idY, Row_A * Col_A * sizeof(double), 0);
        ...
        time_end = InterChiplet::writeSync(time_end, idX, idY, 9, 9, Row_A * Col_A * sizeof(double), 0);
