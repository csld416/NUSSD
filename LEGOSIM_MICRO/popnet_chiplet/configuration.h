...
class configuration {
	...
	private:
		...
		//changed at 2024-6-3
		std::string delay_fname_ = "./delayInfo.txt";
		bool sync_protocol_enable_ = false;
	...
	public:
		...
		//changed at 2024-6-3
		string delayinfo_fname() { return delay_fname_; }
		string delayinfo_fname() const { return delay_fname_; }
		bool sync_protocol_enable() { return sync_protocol_enable_; }
		bool sync_protocol_enable() const { return sync_protocol_enable_; }
